...
#define RV_csr_dmdata0    0xbff // Debug-mode shadow CSR for DM data transfer

#define RV_csr_meiea      0xbe0 // External interrupt pending array
#define RV_csr_meipa      0xbe1 // External interrupt enable array
#define RV_csr_meifa      0xbe2 // External interrupt force array
#define RV_csr_meipra     0xbe3 // External interrupt priority array
#define RV_csr_meinext    0xbe4 // Next external interrupt
#define RV_csr_meicontext 0xbe5 // External interrupt context register

#define RV_csr_msleep     0xbf0 // M-mode sleep control register

#define RV_csr_pmpcfgm0   0xbd0 // Non-locking M-mode enables for PMP regions
