...
MARCH        = rv32imc_zicsr_zba_zbb_zbkb_zbs
#MARCH        = rv32im_zicsr_zba_z
...
CFLAGS = $(PORT_CFLAGS) -I$(PORT_DIR) -I. -I$(COMMON_DIR) -DFLAGS_STR=\"$(FLAGS_STR)\" 
...
OBJOUT 	= -o
LFLAGS 	= -T ../../common/memmap.ld -Wl,--noinhibit-exec -march=$(MARCH) -nostdlib
ASFLAGS = -c -march=$(MARCH)
OFLAG 	= -o
COUT 	= -c

COMMON_DIR ?= ../../common
LFLAGS_END = -lc -lnosys -lgcc
# Flag : PORT_SRCS
# 	Port specific source files can be added here
#	You may also need cvt.c if the fcvt functions are not provided as intrinsics by your compiler!
PORT_SRCS = $(PORT_DIR)/core_portme.c $(PORT_DIR)/ee_printf.c $(PORT_DIR)/cvt.c $(COMMON_DIR)/init_rv.S
PORT_OBJS = $(addsuffix $(OEXT),$(patsubst %.c,%,$(patsubst %.S,%,$(PORT_SRCS))))
vpath %.c $(PORT_DIR)
vpath %.s $(PORT_DIR)
vpath %.S $(PORT_DIR) $(COMMON_DIR)
