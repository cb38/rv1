...
`define REG_KEEP_ATTRIBUTE (* keep = 1'b1 *)
`endif
...
`REG_KEEP_ATTRIBUTE reg                            src_req;
wire                                                       dst_req;

`REG_KEEP_ATTRIBUTE reg                            dst_ack;
wire                                                       src_ack;
...
`REG_KEEP_ATTRIBUTE reg [W_ADDR + W_DATA + 1 -1:0] src_paddr_pwdata_pwrite; // launch
`REG_KEEP_ATTRIBUTE reg [W_ADDR + W_DATA + 1 -1:0] dst_paddr_pwdata_pwrite; // capture

`REG_KEEP_ATTRIBUTE reg [W_DATA + 1 -1:0]          dst_prdata_pslverr;      // launch
`REG_KEEP_ATTRIBUTE reg [W_DATA + 1 -1:0]          src_prdata_pslverr;      // capture
